          ...
          <div v-if="activeTab === 3" class="fade-in">
            <div class="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p class="mb-4 text-sm">This demonstration shows how basic facial recognition works. Upload an image to see the technology in action (processing occurs locally in your browser).</p>
                ...
                <div class="bg-indigo-50 p-4 rounded-lg mb-4">
                  ...
                  <ul class="space-y-2">
                    <li class="flex items-start">
                      ...
                      <span class="text-sm">No images are uploaded to any server - processing happens locally</span>
                    </li>
                    <li class="flex items-start">
                      <svg class="h-4 w-4 text-indigo-500 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                      </svg>
                      <span class="text-sm">Demo uses TensorFlow.js face detection model</span>
                    </li>
                    <li class="flex items-start">
                      <svg class="h-4 w-4 text-indigo-500 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
              ...
              <div class="bg-white p-4 rounded-lg shadow-md">
                <div class="mb-3">
                  <label class="block text-sm font-medium text-gray-700 mb-1">Upload an image</label>
                  <div class="mt-1 flex justify-center">
                    <label for="file-upload" class="cursor-pointer bg-indigo-600 text-white font-medium py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                      Upload a file
                      <input id="file-upload" name="file-upload" type="file" @change="handleImageUpload" accept="image/*" class="sr-only" />
                    </label>
                  </div>
                  <p class="text-xs text-gray-500 text-center mt-2">PNG, JPG up to 5MB</p>
                </div>
              </div>
